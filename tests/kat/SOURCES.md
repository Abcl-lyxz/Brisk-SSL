...
Generated by `python tools/kat.py` on 2026-09-26. Each vector was re-checked
...
| rfc7468 | https://www.rfc-editor.org/rfc/rfc7468.txt | `0b2c3c2087cc0b099789c90e61c0208e87b25793f0ce40090979e8c734b3d989` |
...
- **Device private key (M9, `key.inc`, `mtls_key.inc`).** OFFICIAL: NIST CAVP 186-3
  ...
  NEGATIVE row (pinned above as `rfc7468`). INDEPENDENT ENCODER: OpenSSL 3.5.7 9 Jun 2026. The
